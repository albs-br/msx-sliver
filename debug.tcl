...
ram_watch   add     0xe005      -type word       -desc P.FoV_start      -format dec
ram_watch   add     0xe006      -type word       -desc P.FoV_end        -format dec
ram_watch   add     0xe008      -type word       -desc P.walk_X         -format dec
ram_watch   add     0xe00a      -type word       -desc P.walk_Y         -format dec
